...
public class RoundedCorners extends SystemUI implements Tunable {
    ...
    private void setupRounding() {
        ...
        mOverlay.setAlpha(0);
        mOverlay.findViewById(id.right).setRotation(90);
        ...
        mBottomOverlay.findViewById(id.right).setRotation(180);
        mBottomOverlay.findViewById(id.left).setRotation(270);
    ...
    private void setupPadding(int padding) {
        ...
        if (statusBar != null) {
            TunablePadding.addTunablePadding(statusBar.findViewById(id.keyguard_header), PADDING,
                    padding, FLAG_END);

            FragmentHostManager fragmentHostManager = FragmentHostManager.get(statusBar);
            fragmentHostManager.addTagListener(CollapsedStatusBarFragment.TAG,
                    new TunablePaddingTagListener(padding, id.status_bar));
            fragmentHostManager.addTagListener(QS.TAG,
                    new TunablePaddingTagListener(padding, id.header));
        }
    }
    ...
    public void onTuningChanged(String key, String newValue) {
        ...
        if (SIZE.equals(key)) {
            ...
            setSize(mOverlay.findViewById(id.left), size);
            setSize(mOverlay.findViewById(id.right), size);
            setSize(mBottomOverlay.findViewById(id.left), size);
            setSize(mBottomOverlay.findViewById(id.right), size);
        }
    }
