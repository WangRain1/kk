...
public class QSFragment extends Fragment implements QS {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mQSPanel = view.findViewById(id.quick_settings_panel);
        mQSDetail = view.findViewById(id.qs_detail);
        mHeader = view.findViewById(id.header);
        mFooter = view.findViewById(id.qs_footer);
        mContainer = view.findViewById(id.quick_settings_container);

        mQSDetail.setQsPanel(mQSPanel, mHeader, (View) mFooter);
        mQSAnimator = new QSAnimator(this,
                mHeader.findViewById(id.quick_qs_panel), mQSPanel);

        mQSCustomizer = view.findViewById(id.qs_customize);
